          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-6">
                {editingId ? 'Edytuj notatkÄ™' : 'Nowa notatka'}
              </h2>
              
              <form onSubmit={handleSaveNote} className="flex flex-col gap-4">
                <div>
                  <label className="text-[var(--text-secondary)] text-sm mb-1 block">TytuÅ‚</label>
                  <input 
                    type="text" required
                ...
                <div>
                  <label className="text-[var(--text-secondary)] text-sm mb-1 block">TreÅ›Ä‡</label>
                  <textarea 
                    required
